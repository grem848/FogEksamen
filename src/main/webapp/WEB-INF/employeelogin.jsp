...
<html>
    ...
    <!--Beautiful visualization, stickman, carport and tree-->
    <svg viewBox="0 0 50 20" width="500" height="200">
    <rect x="20" y="10" height="50" width="10" style="stroke:#000000; fill: white"/>
